...
test_path = "./data/val_index.txt"
save_path = "./save/result/"
pretrained_path='./pretrained/pre_train.pth'
object_detect_path = './object_detect_model/ObjectDetectBest2.pt'
face_detect_path = './object_detect_model/MuoiNgoc2.pt'
